...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/HW_QSYS_QSYS_0.v" -work QSYS_0 -cdslib ./cds_libs/QSYS_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/HW_QSYS.v"                                                                 
fi
