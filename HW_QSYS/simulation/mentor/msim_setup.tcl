...
# # End of template
# ----------------------------------------
# If HW_QSYS is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/HW_QSYS_QSYS_0.v" -work QSYS_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/HW_QSYS.v"                               
}
