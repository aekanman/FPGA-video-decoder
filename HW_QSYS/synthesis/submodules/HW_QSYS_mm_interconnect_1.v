...
`timescale 1 ps / 1 ps
module HW_QSYS_mm_interconnect_1 (
	...
	HW_QSYS_mm_interconnect_1_router router (
	...
	HW_QSYS_mm_interconnect_1_router router_001 (
	...
	HW_QSYS_mm_interconnect_1_router_002 router_002 (
	...
	HW_QSYS_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_125_clk_clk),                               //       clk.clk
		.reset              (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_125_clk_clk),                               //       clk.clk
		.reset              (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_125_clk_clk),                               //       clk.clk
		.reset               (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_125_clk_clk),                               //       clk.clk
		.reset              (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_125_clk_clk),                               //       clk.clk
		.reset               (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (clk_125_clk_clk),                               //       clk.clk
		.reset               (video_dma_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HW_QSYS_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
