...
begin
	...
	-- Connect 1d idct
	oned: idct_1D port map(clk, pass,i0,i1,i2,i3,i4,i5,i6,i7,o0,o1,o2,o3,o4,o5,o6,o7);
  
	--first 1d test vector
	pass <= '0';
	i0 <= "0000000001100100";
	i1 <= "0000000001100100";
	i2 <= "0000000000000000";
	...
	--checking that the output of 1d idct is correct
	dst_valid <= src_valid;
	dst_data(15 downto 0) <= o0;--"00000000000000000000000000000111";
	src_ready <= dst_ready;
