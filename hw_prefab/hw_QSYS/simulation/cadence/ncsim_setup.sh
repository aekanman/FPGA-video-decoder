...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ECE423_QSYS_QSYS_0.v" -work QSYS_0 -cdslib ./cds_libs/QSYS_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ECE423_QSYS.v"                                                                 
fi
