...
# # End of template
# ----------------------------------------
# If ECE423_QSYS is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 193 win32 2017.01.07.09:01:01
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ECE423_QSYS"
}
...
ensure_lib        ./libraries/QSYS_0/
vmap       QSYS_0 ./libraries/QSYS_0/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ECE423_QSYS_QSYS_0.v" -work QSYS_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ECE423_QSYS.v"                               
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L QSYS_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L QSYS_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
