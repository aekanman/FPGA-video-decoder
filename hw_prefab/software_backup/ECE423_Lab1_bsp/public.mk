...
# setting SOPC_SYSID_BASE_ADDRESS is 0x201014f0
SOPC_SYSID_FLAG += --sidp=0x201014f0
ELF_PATCH_FLAG  += --sidp 0x201014f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1484098491
SOPC_SYSID_FLAG += --timestamp=1484098491
ELF_PATCH_FLAG  += --timestamp 1484098491
