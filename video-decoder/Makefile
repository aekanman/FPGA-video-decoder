...
C_SRCS += main.c
C_SRCS += common/tables.c
C_SRCS += common/util.c
C_SRCS += decoder/idct.c
C_SRCS += decoder/lossless_decode.c
C_SRCS += decoder/mjpeg423_decoder.c
C_SRCS += decoder/ycbcr_to_rgb.c
C_SRCS += ece423_sd/FatFileSystem.c
C_SRCS += ece423_sd/FatInternal.c
C_SRCS += ece423_sd/debug.c
C_SRCS += ece423_sd/mmc.c
C_SRCS += ece423_sd/ocsdc.c
C_SRCS += ece423_sd/sd_lib.c
C_SRCS += ece423_vid_ctl/ece423_vid_ctl.c
C_SRCS += ece423_vid_ctl/i2c.c
CXX_SRCS :=
ASM_SRCS :=
