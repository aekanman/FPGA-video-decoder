...
void mjpeg423_decode(FAT_FILE_HANDLE file_handle, alt_u32* buffer_out, ece423_video_display* display, int* play_flag, int* skip_fw_flag, int* skip_rv_flag, int* exit_flag, volatile int* timer_flag);
void mjpeg423_decode_new(FAT_FILE_HANDLE* file_handle, alt_u32* buffer_out, ece423_video_display* display);
