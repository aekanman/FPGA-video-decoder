...
#include "system.h"
#include "HW_vid_ctl.h" // New mSGDMA Video Controller
#include "i2c.h"

/******************************************************************
 *                    HW_video_display_init
 *                    ----------------------
 *
...
HW_video_display* HW_video_display_init(char* sgdma_name, int width,
	...
	if (num_buffers > HW_VIDEO_DISPLAY_MAX_BUFFERS) {
		printf("The required number of buffers exceeds the max!\n");
		num_buffers = HW_VIDEO_DISPLAY_MAX_BUFFERS;
...
// Construct mSGDMA descriptors for each Frame Buf
	...
	for (i = 0; i < num_buffers; i++) {
		...
		HW_VIDEO_DISPLAY_BLACK_8, display->bytes_per_frame);
	}
...
/******************************************************************
 *                 HW_video_display_register_written_buffer
 *                 -----------------------------------------
 *
...
/******************************************************************
 *  Function: HW_video_display_clear_screen
 *
...
/******************************************************************
 *          HW_video_display_get_descriptor_span
 *          -------------------------------------
 *
...
/******************************************************************
 *              HW_video_display_allocate_buffers
 *              ----------------------------------
 *
