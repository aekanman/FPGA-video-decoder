/*
 * Main decoder application for the FPGA MJPEG video pipeline.
 *
 * This CPU owns SD-card input, video output, playback controls, mailbox
 * scheduling for the worker CPUs, DMA-backed IDCT acceleration, and display
 * buffer registration.
 */
